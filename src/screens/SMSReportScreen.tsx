...
interface SMSSection { title: string; data: SMSMessage[]; }
...
const SMSReportScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const loadDeviceSms = () => {
    ...
    setAllSms(rawDeviceSms.map(sms => ({ ...sms, type: determineSmsType(sms.body) })));
  };
...
const styles = StyleSheet.create({
  ...
  sectionHeader: { backgroundColor: '#f3f4f6', paddingHorizontal: 16, paddingVertical: 8, marginBottom: 12, borderBottomWidth: 1, borderBottomColor: '#e5e7eb' },
  sectionHeaderText: { fontSize: 14, fontWeight: 'bold', color: '#4b5563' },
